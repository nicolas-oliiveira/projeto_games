...
/**
 *
 * @author nicolas, vent, lucas, nicoly
 */
public class Conexao {
    
    final private String driver = "com.mysql.jdbc.Driver"; // definição do driver MySql para acesso aos dados
    final private String url = "jdbc:mysql://localhost/projetinho"; // acesso ao bd clientes no servidor
    final private String nome = ""; // nome do usuario MySql - usbwebserver
    final private String email = ""; // email do MySql - usbwebserver
